...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-09-2019 a las 17:57:49
...
(1, 'Un maquina', 'Realiza 5 quizzes.'),
(2, 'Influencer de tu casa', 'Consigue que te sigan 5 personas'),
(3, 'Artista', 'Ten un Quiz que ha sido puntuado mas de 10 veces'),
(4, 'Kami', 'Un quiz que has aprobado en moderación, más tarde ha sido publicado'),
(5, 'Kira', '50 quizzes que has rechazado en moderación, han sido finalmente borrados'),
(6, 'Nuevo outfit', 'Has cambiado tu foto de perfil por primera vez'),
(7, 'Juez', 'Has moderado al menos 100 quizzes'),
(8, 'Diana', '¡Enhorabuena! Has conseguido que te publiquen tu primer quiz'),
(9, 'Crítico', 'Puntúa al menos 20 quizzes de la web');
...
(2, 40, 3, '2019-08-20 12:10:25'),
(4, 40, 6, '2019-08-29 08:28:27'),
(5, 40, 2, '2019-08-29 08:31:06');
...
INSERT INTO `logros_proceso` (`id`, `usuario`, `logro`, `cantidad`) VALUES
(1, 40, 7, 100);
...
(42, 40, 'Best quiz 2019', '{\"id\":null,\"creador\":40,\"titulo\":\"Best quiz 2019\",\"image\":\"p1vxpjkp79.jpg\",\"soluciones\":[{\"id\":1,\"titulo\":\"Solucionaca\",\"descripcion\":\"Hehe equisdedawdawdawd\",\"image\":\"1qip715e58.jpg\"},{\"id\":2,\"titulo\":\"Mati_Es_guay\",\"descripcion\":\"dawdawdawdarr\",\"image\":\"93zotur4cxn.jpg\"}],\"preguntas\":[{\"id\":1,\"enunciado\":\"¿Cuál es tu color favorito?\",\"respuestas\":[{\"id\":1,\"enunciado\":\"Naranja\",\"madre\":1,\"afinidades\":[{\"idr\":1,\"ids\":1,\"cantidad\":\"10\"},{\"idr\":1,\"ids\":2,\"cantidad\":0}]},{\"id\":2,\"enunciado\":\"Azul\",\"madre\":1,\"afinidades\":[{\"idr\":2,\"ids\":1,\"cantidad\":0},{\"idr\":2,\"ids\":2,\"cantidad\":\"10\"}]}],\"eleccion\":null},{\"id\":2,\"enunciado\":\"¿Eres más de...?\",\"respuestas\":[{\"id\":1,\"enunciado\":\"Perros\",\"madre\":2,\"afinidades\":[{\"idr\":1,\"ids\":1,\"cantidad\":0},{\"idr\":1,\"ids\":2,\"cantidad\":\"9\"}]},{\"id\":2,\"enunciado\":\"Gatos\",\"madre\":2,\"afinidades\":[{\"idr\":2,\"ids\":1,\"cantidad\":\"10\"},{\"idr\":2,\"ids\":2,\"cantidad\":0}]}],\"eleccion\":null}],\"estrellas\":0,\"fechacreacion\":\"2019-08-28T09:25:02.358Z\"}', '2019-08-28', 1, NULL);
...
(40, 'Exilonmlolllldddawdawddaw', 'exilonmlol@gmail.com', '20b8bb20c0f2e2684a6e40e4147adf3f60fa8fbe53bbad75ed73a0c7e06606db', NULL, 1),
(60, 'nombreprueba', 'nombreprueba@gmail.com', '70bca5a8836a504a81413b0ac35711d025627bf501bb01d6e5f191677abe1fac', NULL, NULL),
(63, 'newman@gmail.com', 'newman@gmail.com', '47d510d858c618de3e49a889680317e698d2dd1881ce5867f364484610562808', NULL, NULL);
...
ALTER TABLE `reportes`
  ...
  ADD CONSTRAINT `reportes_ibfk_2` FOREIGN KEY (`destino`) REFERENCES `users` (`id`);
