...
querys["buscaLogros"] = "SELECT L.*,(SELECT fecha FROM logros_obtenidos where usuario= (select id from users where nickname = ?) and logro = L.id) as fecha FROM logros L";
